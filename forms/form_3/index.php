...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item"><a href="pages/view_data.php" class="nav-link"><i class="far fa-comment-dots"></i> Angalia Maoni</a></li>
        </ul>
    </nav>
    <!-- End nav -->
    <main>
                    ...
                    <div class="wrapper">
                        ...
                        <form method="POST">
                            ...
                            <div class="field address">
                                <div class="addresses">
                                    <div class="input-area">
                                        <input type="text" name="address" id="address" placeholder="Anuani ya makazi">
                                        <i class="icon fas fa-map"></i>
                                        <i class="error error-icon fas fa-exclamation-circle"></i>
                                        <i class="success success-icon fas fa-check-circle"></i>
                                    </div>
                                    <div class="error error-txt">Anuani inahitajika</div>
                                </div>
                            </div>
