...
register_form.onsubmit = (e) => {
    ...
    xhr_2.onreadystatechange = function() {
            ...
            if (this.status === 200 && this.readyState === 4) {
                ...
                if (response.indexOf("Sorry, email already taken") != -1 || response.indexOf("Fields cannot be blank") != -1 || response.indexOf("Password mismatch") != -1 || response.indexOf("Not saved ") != -1) {
