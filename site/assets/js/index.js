...
function scrollFunction() {
    if (document.body.scrollTop > 80 || document.documentElement.scrollTop > 80) {
        ...
        document.getElementById('header').style.borderBottom = '1px solid #d3d3d3';
        ...
        document.getElementById('navbar-brand').style.marginTop = '15px';
        document.getElementById('navbar-brand').style.marginBottom = '20px';
        ...
        document.getElementById('nav-link').style.marginTop = '16px';
